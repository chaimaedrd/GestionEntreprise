...
<body>
    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-md-6">
                <h5 class="fw-bold mb-0">Liste des Affectations</h5>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-end">
                    <button id="addAffectation" class="btn btn-primary btn-sm me-3" data-bs-toggle="modal" data-bs-target="#createModal"><i class="fas fa-user-plus" ></i> Nouveau</button>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            <form action="" method="POST" id="formAffectation">
                ...
                <label for="roleAffectation">Role:</label><br>
                <input type="text" id="roleAffectation" name="roleAffectation" class="form-control"><br>
                <label for="AffectationProjet">Projet:</label><br>
                <div class="dropdown">
                    <select class="form-select" id="projetsSelect">
                        <option value="0" selected disabled>choisir un Projet</option>
                    </select>
                </div><br>
                <label for="AffectationEmploye">Employe:</label><br>
                <div class="dropdown">
                    <select class="form-select" id="employesSelect">
                        <option value="0" selected disabled>choisir un employe</option>
                    </select>
                </div>
            </form> 
        </div>
    ...
    <script src="processAffectation.js" type="module"></script>
