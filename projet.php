...
<body>
    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-md-6">
                <h5 class="fw-bold mb-0">Liste des Projets</h5>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-end">
                    <button id="addProjet" class="btn btn-primary btn-sm me-3" data-bs-toggle="modal" data-bs-target="#createModal"><i class="fas fa-user-plus" ></i> Nouveau</button>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            <form action="" method="POST" id="formProjet">
                ...
                <label for="nomProjet">Nom:</label><br>
                <input type="text" id="nomProjet" name="nomProjet" class="form-control"><br>
                <label for="DepartProjet">Departement:</label><br>
                <div class="dropdown">
    ...
    <script src="processProjet.js" type="module"></script>
